...
const WomenPortal = () => {
  ...
  const handleSubmit = () => {
    setError("");
    if (!data.type || !data.age || !data.education || !data.location || !data.need) {
          ...
          <div className="max-w-3xl mx-auto px-8 py-12 space-y-12 pb-24">
            ...
            <section ref={(el) => (sectionRefs.current[5] = el)} data-step="5" className="scroll-mt-32 pt-4">
              ...
              <div className="mt-16 flex flex-col items-center">
                ...
                {!error && <p className="mt-4 text-sm text-slate-500">Fill in all details to see personalized programs.</p>}
              </div>
            </section>
