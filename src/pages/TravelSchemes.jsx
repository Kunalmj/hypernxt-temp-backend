...
const TravelSchemes = () => {
  ...
  useEffect(() => {
    ...
    fetchCategory("travel_tourism/")
      ...
      .catch((err) => {
        console.error("Failed to fetch travel schemes, falling back to local database:", err);
      ...
      <div className="min-h-screen bg-[#f5f7fb]">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <button onClick={() => navigate(-1)} className="inline-flex items-center gap-1.5 text-rose-200 text-[0.82rem] font-semibold bg-transparent border-none cursor-pointer p-0 mb-4 hover:text-white transition-colors">← Back to All Categories</button>
            <h1 className="text-white text-[1.45rem] md:text-[1.75rem] font-extrabold mb-1">Travel &amp; Tourism</h1>
            <p className="text-rose-100 text-[0.85rem]">Explore schemes in this category</p>
