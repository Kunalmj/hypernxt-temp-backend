...
const HealthSchemes = () => {
  ...
  useEffect(() => {
    ...
    fetchCategory("health_wellness/")
      ...
      .catch((err) => {
        console.error("Failed to fetch health schemes, falling back to local database:", err);
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-5 relative max-w-2xl">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-xl border-none bg-white text-[0.9rem] text-[#0f172a] placeholder-[#94a3b8] focus:outline-none focus:ring-2 focus:ring-green-300"
