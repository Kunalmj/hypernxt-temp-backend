...
const HousingSchemes = () => {
  ...
  useEffect(() => {
    ...
    fetchCategory("housing_shelter/")
      ...
      .catch((err) => {
        console.error("Failed to fetch housing schemes, falling back to local database:", err);
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-5 relative max-w-2xl">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-white rounded-xl border-none text-[0.9rem] text-[#0f172a] placeholder-[#94a3b8] focus:outline-none focus:ring-2 focus:ring-blue-300"
                style={{ boxShadow: "0 2px 8px rgba(255, 255, 255, 0.12)" }}
              />
            </div>
          </div>
        </div>
