...
const SafetySchemes = () => {
  ...
  useEffect(() => {
    setLoading(true);
    fetchCategory("public_safety_law_justice/")
      .then((res) => {
      ...
      .catch((err) => {
        console.error("Failed to fetch safety schemes, falling back to local database:", err);
            ...
            <div className="flex flex-col gap-4">
              {loading ? (
                ...
                <div className="bg-white rounded-2xl p-10 text-center" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.06), inset 0 0 0 1px rgba(226,232,240,0.8)" }}>
                  <p className="text-[#2563eb] text-[0.9rem]">No schemes match your filters.</p>
                </div>
              ) : (
                filtered.map((scheme) => (
